...
account_file = 'experiment1/accounts.txt'
NO_EMAIL = 'no_email'
...
def control_treatment(unit, configuration):
    ...
    unit.search_for_measuring_price(
        training_terms, price_condition=click_condition,number_of_results_to_click=4)
...
def measurement(unit, configuration):
    print(">>>>>>Enter measurement function, Will sleep for 10s from now")
    return
    time.sleep(10)# this one is prevention of google banning of activity
