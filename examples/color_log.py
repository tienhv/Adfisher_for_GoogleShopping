...
def initialize_logger(output_dir):
    ...
    color = RainbowLoggingHandler(sys.stdout) 
    logger.addHandler(color)
    ...
    handler = logging.FileHandler(os.path.join(output_dir, "d_error.log"),"w", encoding=None, delay="true")
    ...
    handler = logging.FileHandler(os.path.join(output_dir, "d_all.log"),"w")
...
if __name__ == "__main__":
    ...
    #handler = RainbowLoggingHandler(sys.stdout) # only this line is okay
    
    #formatter = logging.Formatter("%(asctime)s - %(name)s - %(levelname)s - %(message)s")
    #handler.setFormatter(formatter)
    #root_logger.addHandler(handler)
    
    logger = initialize_logger('.')#logging.getLogger("test")
    #logger.addHandler(logging.FileHandler("delete.log"))
